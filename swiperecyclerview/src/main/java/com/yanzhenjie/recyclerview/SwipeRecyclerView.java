...
public class SwipeRecyclerView extends RecyclerView {
    ...
    private AdapterDataObserver mAdapterDataObserver = new AdapterDataObserver() {
        ...
        public void onItemRangeChanged(int positionStart, int itemCount) {
            ...
            Log.e("zx", "onItemRangeChanged: " + positionStart + "  " + itemCount);
        ...
        public void onItemRangeChanged(int positionStart, int itemCount, Object payload) {
            positionStart += getHeaderCount();
            Log.e("zx", "onItemRangeChanged: " + positionStart + "  " + itemCount + "  " + payload);
        ...
        public void onItemRangeInserted(int positionStart, int itemCount) {
            positionStart += getHeaderCount();
            Log.e("zx", "onItemRangeInserted: " + positionStart + "  " + itemCount);
        ...
        public void onItemRangeRemoved(int positionStart, int itemCount) {
            positionStart += getHeaderCount();
            Log.e("zx", "onItemRangeRemoved: " + positionStart + "  " + itemCount);
        ...
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
            ...
            Log.e("zx", "onItemRangeMoved: " + fromPosition + "  " + toPosition);
