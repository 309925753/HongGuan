...
//    protected LinearLayout mImageLayout;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFrameLayout = mRootView.findViewById(R.id.liveness_surface_layout);
        ...
        mFaceDetectRoundView = mRootView.findViewById(R.id.liveness_face_round);
        mCloseView = mRootView.findViewById(R.id.liveness_close);
        mSoundView = mRootView.findViewById(R.id.liveness_sound);
        ...
        mTipsTopView = mRootView.findViewById(R.id.liveness_top_tips);
        mTipsBottomView = mRootView.findViewById(R.id.liveness_bottom_tips);
        mSuccessView = mRootView.findViewById(R.id.liveness_success_image);
