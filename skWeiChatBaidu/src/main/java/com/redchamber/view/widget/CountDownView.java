package com.redchamber.view.widget;
...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRingProgressTextSize = a.getDimensionPixelSize(R.styleable.CountDownView_progressTextSize, ScreenUtil.dip2px(context, 20));
        mProgressTextColor = a.getColor(R.styleable.CountDownView_progressTextColor, context.getResources().getColor(R.color.colorAccent));
