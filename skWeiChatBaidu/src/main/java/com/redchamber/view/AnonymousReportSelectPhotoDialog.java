 ...
 * 匿名举报-选择截图
 */
public class AnonymousReportSelectPhotoDialog extends Dialog {

    private Unbinder mBinder;

    private OnConfirmListener mOnConfirmListener;

    public AnonymousReportSelectPhotoDialog(Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.red_dialog_anonymous_report_select_photo);
