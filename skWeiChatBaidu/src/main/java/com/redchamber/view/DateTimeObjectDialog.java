 ...
 * 期望对象
 */
public class DateTimeObjectDialog extends Dialog implements DateShowAdapter.onShowClickListener {
    ...
    public DateTimeObjectDialog(Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_date_object);
    ...
    private void initData() {
        String[] arr = getContext().getResources().getStringArray(R.array.datatime_object);
