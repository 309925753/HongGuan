...
import com.redchamber.message.adapter.MessageDianzanAdapter;
 ...
 * 评论通知
 */
public class UserEnrollActivity extends BaseActivity {
    ...
    private MessageDianzanAdapter messageAdapter;
    ...
    protected void initView() {
        ...
        messageAdapter = new MessageDianzanAdapter(null);
    ...
    private void initOnClick() {
        messageAdapter.setOnPackageClickListener(new MessageDianzanAdapter.onPackageClickListener() {
            @Override
    ...
    private void getMessageList() {
        ...
        DialogHelper.showDefaulteMessageProgressDialog(UserEnrollActivity.this);
        HttpUtils.post().url(coreManager.getConfig().RED_SYSTEM_MESSAGE_LIST)
                ...
                .execute(new ListCallback<SysteMessageBean>(SysteMessageBean.class) {
                    ...
                    public void onResponse(ArrayResult<SysteMessageBean> result) {
                        ...
                        if (Result.checkSuccess(UserEnrollActivity.this, result)) {
                            list = result.getData();
                    ...
                    public void onError(Call call, Exception e) {
                        ...
                        Toast.makeText(UserEnrollActivity.this, R.string.check_network, Toast.LENGTH_SHORT).show();
                    }
                });
