...
public class DianzanActivity extends BaseActivity {
    ...
    private void getMessageList() {
        ...
        DialogHelper.showDefaulteMessageProgressDialog(DianzanActivity.this);
        HttpUtils.post().url(coreManager.getConfig().RED_SYSTEM_MESSAGE_LIST)
                ...
                .execute(new ListCallback<SysteMessageBean>(SysteMessageBean.class) {
                    ...
                    public void onResponse(ArrayResult<SysteMessageBean> result) {
                        ...
                        if (Result.checkSuccess(DianzanActivity.this, result)) {
                            list = result.getData();
                    ...
                    public void onError(Call call, Exception e) {
                        ...
                        Toast.makeText(DianzanActivity.this, R.string.check_network, Toast.LENGTH_SHORT).show();
                    }
                });
