 ...
 * 报名  点赞
 */
public class MessageDianzanAdapter extends BaseQuickAdapter<SysteMessageBean, MessageDianzanAdapter.PackageViewHolder> {

    private MessageDianzanAdapter.onPackageClickListener mOnPackageClickListener;
    ...
    public void setOnPackageClickListener(MessageDianzanAdapter.onPackageClickListener mOnPackageClickListener) {
        this.mOnPackageClickListener = mOnPackageClickListener;
    }


    public MessageDianzanAdapter(@Nullable List<SysteMessageBean> data) {
